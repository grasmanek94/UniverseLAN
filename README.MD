...
| Tropico 6 | :white_check_mark:(2) <br>:large_orange_diamond:  | 1.139.2 | Also other games are displayed? Game has custom networking?<br> Build 161 worked, build 243 seems to be broken (can't join lobby) | 
