...
bool runPublicLobby(const Arguments& arguments, galaxy::api::IUser* const user, std::vector<std::string>& records)
{
    ...
    if (creator)
    {
        ...
        matchmaking->CreateLobby(galaxy::api::LOBBY_TYPE_PUBLIC, 2, true,
