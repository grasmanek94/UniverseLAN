...
1. Obtain the object only through its documented owner or accessor, exercise the adjacent public lifecycle, then release it only through that owner or documented shutdown path; do not call `~IError` directly.
