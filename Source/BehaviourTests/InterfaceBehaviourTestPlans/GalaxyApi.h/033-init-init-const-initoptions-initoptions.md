...
static void GALAXY_CALLTYPE Init(const InitOptions& initOptions)
```
- Observed snapshot availability: 1.87.0, 1.92.0, 1.95.0, 1.99.0, 1.104.2, 1.104.3, 1.104.4, 1.106.0, 1.109.0, 1.112.2, 1.113.1, 1.113.3, 1.114.9.
- Relevant build matrix gate: GALAXY_BUILD_FEATURE_HAS_INITOPTIONS.
