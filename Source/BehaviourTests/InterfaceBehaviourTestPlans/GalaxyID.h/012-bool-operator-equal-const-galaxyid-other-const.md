...
- Documented fact: the header says equality may compare all sorts of `GalaxyID`.
- Characterization required: equality of independently issued IDs beyond the public relationships the test establishes.
