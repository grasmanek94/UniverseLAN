...
- Documented fact: the header defines this operator as the opposite of equality.
- Characterization required: all relationships not established by public IDs in the test.
