...
- `[ ] Pass` `[ ] Fail` `[x] Not-run`
- Least-feasible next step: provide one documented DLC product fixture that deterministically exercises the failure callback without retaining product IDs or account state.
