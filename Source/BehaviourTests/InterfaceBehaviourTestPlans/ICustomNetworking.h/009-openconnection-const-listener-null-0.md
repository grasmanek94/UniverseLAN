...
virtual void OpenConnection(const char* connectionString, IConnectionOpenListener* const listener = NULL) = 0;
```
- Observed snapshot availability: 1.139.2, 1.139.5, 1.139.6, 1.139.9, 1.140.0, 1.142.0, 1.144.1, 1.148.1, 1.148.2, 1.148.3, 1.148.5, 1.148.6, 1.148.7, 1.148.11, 1.148.14, 1.149.0, 1.150.0, 1.151.0, 1.152.1, 1.152.2, 1.152.6, 1.152.9, 1.152.11.
- Relevant build matrix gate: GALAXY_BUILD_FEATURE_HAS_ICONNECTIONLISTENERS.
- Existing coverage: `Simple/custom-networking-loopback-roundtrip-close` directly names and exercises `ICustomNetworking::OpenConnection`, but does not establish coverage of this listener overload's successful terminal path.
