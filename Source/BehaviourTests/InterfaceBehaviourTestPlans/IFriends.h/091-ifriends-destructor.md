...
1. Obtain the interface only through its documented accessor, exercise the adjacent public lifecycle, then use documented SDK shutdown; do not call `~IFriends` directly.
