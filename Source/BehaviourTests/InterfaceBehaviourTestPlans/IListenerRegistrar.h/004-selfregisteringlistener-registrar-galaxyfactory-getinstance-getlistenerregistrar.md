# `SelfRegisteringListener(IListenerRegistrar* _registrar = GalaxyFactory::GetInstance()->GetListenerRegistrar())`
...
SelfRegisteringListener(IListenerRegistrar* _registrar = GalaxyFactory::GetInstance()->GetListenerRegistrar())
```
- Observed snapshot availability: 1.57.0, 1.60.0, 1.61.0, 1.64.0.
