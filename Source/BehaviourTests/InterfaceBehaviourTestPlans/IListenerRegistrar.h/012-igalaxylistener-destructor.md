...
- `[ ] Pass` `[ ] Fail` `[x] Not-run`
- Least-feasible next step: observe the smallest documented listener unregistration and owner-release lifecycle in both lanes, then add only the boundary observation needed to explain a difference.
