...
1. Obtain the interface only through its documented accessor, finish or close public storage operations, then use SDK shutdown; do not call `~IStorage` directly.
