...
1. Obtain the interface only through its documented accessor, finish or bound public telemetry requests, then use SDK shutdown; do not call `~ITelemetry` directly.
