...
1. Establish self and explicit-peer user-data records where public setup permits, then call `GetUserDataCopy` with the default `GalaxyID()` and each explicit `GalaxyID`.
