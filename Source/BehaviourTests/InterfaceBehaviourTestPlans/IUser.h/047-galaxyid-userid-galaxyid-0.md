...
1. Construct `GalaxyID` with defaults and with one documented explicit field at a time; inspect only public fields/value semantics exposed by the struct or class.
