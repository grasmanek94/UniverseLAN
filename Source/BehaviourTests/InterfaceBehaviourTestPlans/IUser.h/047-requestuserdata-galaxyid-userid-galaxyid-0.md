...
virtual void RequestUserData(GalaxyID userID = GalaxyID()) = 0;
```
- Observed snapshot availability: 1.73.0, 1.74.0, 1.75.0, 1.76.0, 1.77.0, 1.80.0, 1.87.0, 1.92.0, 1.95.0, 1.99.0, 1.100.2, 1.104.2, 1.104.3, 1.104.4, 1.106.0, 1.109.0, 1.112.2, 1.113.1, 1.113.3, 1.114.9, 1.121.2, 1.124.0, 1.125.2, 1.126.1, 1.127.0, 1.128.3, 1.130.0, 1.131.3, 1.132.1, 1.133.0, 1.133.6, 1.134.8, 1.134.9, 1.135.0, 1.138.0.
...
1. Call `RequestUserData` with the default `GalaxyID()` and with an explicit self/peer `GalaxyID` where public setup permits.
2. Pump the public processing API to a bounded deadline and record documented global-listener or queryable data observations separately from delivery characterization.
3. Complete ordinary shutdown cleanup.
