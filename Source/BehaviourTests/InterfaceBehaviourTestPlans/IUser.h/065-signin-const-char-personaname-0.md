# `virtual void SignIn(const void* steamAppTicket, uint32_t steamAppTicketLength, const char* personaName) = 0;`
...
virtual void SignIn(const void* steamAppTicket, uint32_t steamAppTicketLength, const char* personaName) = 0;
```
- Observed snapshot availability: 1.77.0, 1.80.0, 1.87.0.
