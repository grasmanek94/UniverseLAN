...
virtual void SignInUWP(IAuthListener* const listener = NULL) = 0;
```
- Observed snapshot availability: 1.133.0, 1.133.6, 1.134.8, 1.134.9, 1.134.10, 1.135.0, 1.138.0, 1.139.2, 1.139.5, 1.139.6, 1.139.9, 1.140.0, 1.142.0, 1.144.1, 1.148.1, 1.148.2, 1.148.3.
...
- `[ ] Pass` `[ ] Fail` `[x] Not-run`
- Least-feasible next step: run the smallest valid `SignInUWP` probe in both lanes, then add only the documented boundary or lifecycle observation needed to explain a difference.
