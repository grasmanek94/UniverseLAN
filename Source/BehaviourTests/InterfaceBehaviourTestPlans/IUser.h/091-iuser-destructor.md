...
1. Obtain the interface only through its documented accessor, finish or bound public authentication requests, then use SDK shutdown; do not call `~IUser` directly.
