...
1. Establish the documented prerequisite state in both lanes, then call `GetNotification` initially and after one valid public transition; record only its return/error and public state relation.
