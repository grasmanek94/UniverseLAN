# `virtual void OnConnectionStateChange(GogServicesConnectionState connected) = 0;`
...
virtual void OnConnectionStateChange(GogServicesConnectionState connected) = 0;
```
- Observed snapshot availability: 1.133.0.
- Relevant build matrix gate: GALAXY_BUILD_FEATURE_HAS_IUTILS.
- Existing coverage: No grounded existing coverage identified: `Source/BehaviourTests/COVERAGE.md` does not directly name this `IUtils::OnConnectionStateChange` declaration.
