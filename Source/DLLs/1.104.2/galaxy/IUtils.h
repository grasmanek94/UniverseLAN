...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * @param overlayVisible Indicates if overlay is in front of the game.
			 */
		...
		public:
			 ...
			 *
			 * @param overlayState Indicates current state of the overlay.
			 */
			virtual void OnOverlayStateChanged(OverlayState overlayState) = 0;
		};

		/**
		 * Globally self-registering version of IOverlayInitializedListener.
		 */
		...
		public:
			 ...
			 *
			 * In order for the overlay to be initialized successfully, first it must be enabled
