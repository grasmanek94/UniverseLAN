...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * @param userID The ID of the user that sent the friend invitation.
		...
		public:
			 ...
			 *
			 * @param userID The ID of the user that sent the invitation.
		...
		public:
			 ...
			 *
			 * This call in asynchronous. Responses come to the IDeleteFriendListener.
			 *
