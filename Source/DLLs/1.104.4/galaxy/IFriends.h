	...
	namespace api
	{
		...
		public:
			...
			enum InvitationDirection {
				INVITATION_DIRECTION_INCOMING, ///< The user indicated in the notification was the invitor.
			 ...
			 * @param invitationDirection The direction of the invitation that determines the invitor and the invitee.
			 */
		...
		public:
			 ...
			 *
			 * @remark This function can be used only in IFriendInvitationsListRetrieveListener callback.
			 *
