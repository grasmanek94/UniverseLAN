...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 * @remark This method is experimental and may change in the future.
			 *
			 * @remark The user must be in the specified chat room in order to retrieve
			 * the messages.
			 *
			 * @param chatRoomID The ID of the chat room.
			 * @param limit The maximum number of messages to retrieve or 0 for using default.
			 * @param referenceMessageID The ID of the oldest of the messages that were already retrieved.
			 */
			 ...
			 *
			 * Marks all the messages in the specified chat room up to the one
			 * received last as read.
			 *
			 * @remark This method is experimental and may change in the future.
			 *
			 * @remark The user must have read messages in the specified chat room
			 * in order to mark it as read.
			 *
			 * @param chatRoomID The ID of the chat room.
			 */
