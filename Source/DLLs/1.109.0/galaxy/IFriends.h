...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * @param userID The ID of the user who sent the friend invitation.
			 * @param sendTime The time at which the friend invitation was sent.
			 */
		...
		public:
			 ...
			 *
			 * @param userID The ID of the user who sent the invitation.
			 * @param accept True when accepting the invitation, false when declining.
			 */
		...
		public:
			 ...
			 *
			 * @param userID The ID of the user who has just been added to the friend list.
			 * @param invitationDirection The direction of the invitation that determines the inviter and the invitee.
			 */
		...
		public:
			 ...
			 *
			 * @param userID The ID of the user requested to be removed from the friend list.
			 */
		...
		public:
			 ...
			 *
			 * @param userSpecifier The user specifier by which user search was performed.
			 * @param userID The ID of the found user.
			 */
		...
		*/
		...
		public:
			 ...
			 * @param userID The ID of the user.
			 */
			virtual void SendFriendInvitation(GalaxyID userID) = 0;

			/**
			 * Performs a request for the user's list of incoming friend invitations.
			 *
			 * This call is asynchronous. Responses come to the IFriendInvitationsListRetrieveListener.
			 */
			 ...
			 * @remark This function can be used only in IFriendInvitationListRetrieveListener callback.
			 *
			 * @param index Index as an integer in the range of [0, number of friend invitations).
			 * @param userID The ID of the user who sent the invitation.
			 * @param sendTime The time at which the friend invitation was sent.
			 */
			 ...
			 * @param accept True when accepting the invitation, false when declining.
			 */
			virtual void RespondToFriendInvitation(GalaxyID userID, bool accept) = 0;
			 ...
			 *
			 * @param userID The ID of the user to be removed from the friend list.
			 */
			virtual void DeleteFriend(GalaxyID userID) = 0;
			...
			*/
			 ...
			 *
			 * @remark For this call to work, the overlay needs to be initialized first.
			 ...
			 *
			 * @param userSpecifier The specifier of the user.
			 */
			virtual void FindUser(const char* userSpecifier) = 0;
		};
