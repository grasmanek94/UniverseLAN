...
namespace galaxy
{
	namespace api
	{
		...
		struct InitOptions
		{
			 ...
			 * @param [in] _galaxyPeerPath Path to the galaxyPeer library location.
			 * @param [in] _throwExceptions Indicates if Galaxy should throw exceptions.
		...
		public:
			 ...
			 * @param [in] clientSecret The secret of the client.
			 * @param [in] throwExceptions Indicates if Galaxy should throw exceptions.
			 */
			 ...
			 * @param [in] clientID The ID of the client.
			 * @param [in] clientSecret The secret of the client.
			 * @param [in] galaxyPeerPath Path to the galaxyPeer library location.
			 * @param [in] throwExceptions indicates if Galaxy should throw exceptions.
			 */
