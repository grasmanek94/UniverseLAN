...
namespace galaxy
{
	namespace api
	{
		...
		enum ListenerType
		{
			...
			_STORAGE_SYNCHRONIZATION, ///< Used by IStorageSynchronizationListener. @deprecated Synchronization is performed solely by Galaxy Client.
		...
		public:
			 ...
			 * IGalaxy::Shutdown().
			 *
			 * @param [in] _registrar The instance of IListenerRegistrar to use for registering and unregistering. Defaults to the one provided by Galaxy Peer.
			 */
