...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 * @param [in] ps4TitleID The PlayStation 4 title ID.
			 * @param [in] ps4TitleSecret The PlayStation 4 title secret.
			 * @param [in] ps4TitleSecretLength The length of the title secret.
			 */
