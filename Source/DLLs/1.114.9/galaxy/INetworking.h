...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * @remark NAT type detection is performed automatically when creating or joining a lobby.
			 */
			 ...
			 *
			 * @pre NAT type detection is performed automatically when creating or joining a lobby.
			 *
			 ...
			 *
			 * @remark CONNECTION_TYPE_DIRECT is returned for the currect user ID.
			 *
