...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * In order to read the metadata of a downloaded file call
			 ...
			 * @param [in] metadataCount The number of metadata pairs (tag/value) for a downloaded file.
			 */
		...
		public:
			...
			/**
			 * Function used to get the metadata key of the retrieved file.
			 * 
			...
			/**
			 * Function used to get the metadata value of the retrieved file.
			 *
			 * Call for this function is allowed inside ICloudStorageGetFileListListener::OnGetFileSuccess() only.
			 *
