...
namespace galaxy
{
	namespace api
	{
		 ...
		 * incoming packets may be handled by the GameServerGlobalNetworkingListener.
		 */
		 ...
		 * was created and before it was initialized.
		 *
		 * @pre Delete all self-registering listeners before calling ShutdownGameServerEx().
		 *
