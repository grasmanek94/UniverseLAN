	...
	namespace api
	{
		...
		public:
			...
			enum FailureReason
			{
				...
				FAILURE_REASON_ABORTED, ///< Request aborted.
				FAILURE_REASON_CONNECTION_FAILURE, ///< Unable to communicate with backend services.
				FAILURE_REASON_CONFLICT /// < Expected hash parameter doesn't match the hash in the container.
			};
		...
		public:
			 ...
			 * @param [in] container The name of the containter.
			 * @param [in] name The name of the file in cloud storage.
			 * @param [in] userParam The parameter passed to readFunc and rewindFunc on every call.
			 ...
			 * @param [in] hash The precalculated hash (see ICloudStorage::CalculateHash() method). Will be calculated internally if ommited (NULL or empty string).
			 */
			 ...
			 * @param [in] bufferLength The size of the buffer for the data.
			 * @param [in] listener The listener for the specific operation.
			 * @param [in] savegameType The type of the savegame.
			 * @param [in] timeStamp The timestamp of the uploaded object. Current time will be set by default.
			 * @param [in] hash The precalculated hash (see ICloudStorage::CalculateHash() method). Will be calculated internally if ommited (NULL or empty string).
			 ...
			 *
			 * Optional parameter expectedHash enforces checking if the file has the same hash as expected.
			 * This prevents removing a file in case it was changed in the meantime.
			 * 
			 * @param [in] container The name of the containter.
			 * @param [in] name The name of the file in cloud storage.
			 * @param [in] listener The listener for the specific operation.
			 * @param [in] expectedHash The expected hash of a file to be deleted.
			 */
