...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 * claiming a failure if there are no packets on specified channel yet.
			 *
			...
			/**
			 * Checks for any incoming packets on the specified channel.
			 *
			...
			/**
			 * Retrieves current ping value in milliseconds with specified entity, i.e.
