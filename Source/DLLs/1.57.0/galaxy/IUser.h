...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 * process is finished.
			 *
			 * If the user is not able to sign in or gets signed out, there might be
			 * either a networking issue or a limited availability of Galaxy services.
			 *
			 * After loosing authentication the user needs to sign in again in order
			 * for the Galaxy client to operate.
			 *
