...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * @remark Retrieve definitions of leaderboards first by calling RequestLeaderboards().
			 *
			 * @param name The name of the leaderboard.
			 ...
			 *
			 * @param name The name of the leaderboard.
			 * @param countBefore The number of entries placed before the user's entry to retrieve.
			 * @param countAfter The number of entries placed after the user's entry to retrieve.
			 * @param userID The ID of the user. It can be omitted when requesting for own data.
			 */
