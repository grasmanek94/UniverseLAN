...
namespace galaxy
{
	namespace api
	{
		...
		public:
			 ...
			 *
			 * @remark Private lobbies are omitted in responses to RequestLobbyList(),
			 * thus in order for other users to be able to join it, you need to
			 * communicate the lobby to their Galaxy Peer by calling
			 * InviteUserToLobby().
			 * @todo: implement invitations to lobby
			 *
			 * @param lobbyType The type of the lobby.
			 * @param maxMembers The maximum number of members allowed for the lobby.
			 */
			...
			/**
			 * Joins the specified existing lobby.
			 *
			...
			/**
			 * Returns the maximum number of users that can be in the specified lobby.
			 *
			...
			/**
			 * Returns the GalaxyID of a user in the specified lobby.
			 *
			...
			/**
			 * Refreshes info about the specified lobby.
			 *
			...
			/**
			 * Returns an entry from the properties of the specified lobby.
			 *
			...
			/**
			 * Creates or updates an entry in the properties of the specified lobby.
			 *
			...
			/**
			 * Returns the number of entries in the properties of the specified lobby.
			 *
			 * @param lobbyID The ID of the lobby.
			...
			/**
			 * Returns a property of the specified lobby by index.
			 *
			 * @param lobbyID The ID of the lobby.
			...
			/**
			 * Clears a property of the specified lobby by its name.
			 *
			...
			/**
			 * Returns an entry from the properties of the specified member of the
			 * specified lobby.
			 *
			...
			/**
			 * Returns the number of entries in the properties of the specified member
			 * of the specified lobby.
			 *
			 * @param lobbyID The ID of the lobby.
			 * @param memberID The ID of the lobby member.
			 * @return The number of entries, or 0 if failed.
			...
			/**
			 * Returns a property of the specified lobby member by index.
			 *
			 * @param lobbyID The ID of the lobby.
			 * @param memberID The ID of the lobby member.
			 * @param index Index as an integer in the range of [0, number of entries).
			...
			/**
			 * Clears a property of the specified lobby member by its name.
			 *
			 ...
			 *
			 * @remark Only the members of the lobby are allowed to check who is its
			 * owner.
			 *
			 * @param lobbyID The ID of the lobby.
			...
			/**
			 * Receives a specified message from one of the members of specified lobby.
			 *
			 * @param lobbyID The ID of the lobby.
			 * @param messageID The ID of the message.
			 * @param senderID The ID of the sender.
			...
			/**
			 * Copies an entry from the properties of the specified lobby.
			 *
			...
			/**
			 * Copies an entry from the properties of the specified member of the
			 * specified lobby.
			 *
