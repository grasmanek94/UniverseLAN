...
namespace galaxy
{
	namespace api
	{
		...
		*/
		class IUserTimePlayedRetrieveListener : public GalaxyTypeAwareListener<LEADERBOARD_RETRIEVE>
		{
		public:
		...
		*/
		...
		public:
			...
			/**
			 * Performs a request for entries of a specified leaderboard for and near given user.
			 *
