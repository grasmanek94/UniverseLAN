...
namespace galaxy
{
	namespace api
	{
		 ...
		 *
		 * @subsection richpresence RichPresence
		 *
		 ...
		 *
		 * The Galaxy API allows you to store files in Galaxy's backend services. The files can be synchronized by calling
		 * IStorage::Synchronize(). After the synchronization is done you can handle them with usage of IStorage interface.
		 *
		 * @subsection DLC discovery
		 *
