...
add_executable(universelan-dllhost-${GALAXY_VERSION} WIN32 FactoryHost.cxx )

target_include_directories(universelan-dllhost-${GALAXY_VERSION} PUBLIC ".")

target_compile_definitions(universelan-dllhost-${GALAXY_VERSION} PUBLIC "HOST_FACTORY")
