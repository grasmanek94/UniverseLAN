...
namespace universelan {
	...
	Lobby::Lobby() :
		id{ galaxy::api::FromRealID(galaxy::api::IDType::ID_TYPE_LOBBY, GlobalUniqueID::get()) }, owner_id{}, max_members{}, joinable{true}, topology_type{}, type{},
		current_message_id{ 1 }, data{}, user_data{}, messages{} {}

	Lobby::Lobby(GalaxyID lobby_id) :
		id{ galaxy::api::FromRealID(galaxy::api::IDType::ID_TYPE_LOBBY, lobby_id.ToUint64()) }, owner_id{}, max_members{}, joinable{true}, topology_type{}, type{},
		current_message_id{ 1 }, data{}, user_data{}, messages{} {}
