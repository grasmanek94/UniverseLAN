...
namespace universelan {
	...
	public:
		...
		static const std::string ROOT_CLOUD_METADATA;
		...
		std::filesystem::path GetPathCloud(const std::string& container, const std::string& file_name) const;
		std::filesystem::path GetPath(const std::string& root, const std::string& file_name) const;
		std::filesystem::path GetPath(const std::string& root, const std::string& container, const std::string& file_name) const;
		...
		bool ExistsCloud(const std::string& container, const std::string& file_name) const;
		...
		bool RemoveCloud(const std::string& container, const std::string& file_name) const;
		...
		bool WriteCloud(const std::string& container, const std::string& file_name, const char* data, size_t data_length) const;
		...
		std::vector<char> ReadCloud(const std::string& container, const std::string& file_name) const;
		...
		uint32_t ReadCloud(const std::string& container, const std::string& file_name, char* data, size_t data_length, size_t offset = 0) const;
		...
		uint32_t GetSizeCloud(const std::string& container, const std::string& file_name) const;
		...
		uint32_t GetTimestampCloud(const std::string& container, const std::string& file_name) const;
		...
		uint32_t GetFileCountCloud(const std::string& container) const;
		...
		std::string GetFileNameByIndexCloud(const std::string& container, uint32_t index) const;
		...
		static std::string FilterBadFilenameChars(std::string file_name);
